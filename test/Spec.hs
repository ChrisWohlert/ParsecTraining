    ...
    describe "Lib.run_parseClass" $ do
      it "returns a Class from a .cs file" $ do
        run_parseClass someClass `shouldBe` Right (Class { usings = ["System","System.Collections.Generic","System.Security","Core.Constants","Core.Models.Shared","Core.Queries","Core.Queries.Shared","Core.User","DataAccess.Bruger","DataAccess.Database","System.Linq","AutoMapper.QueryableExtensions"]
                                                    ...
                                                    , members = [Property "DatabaseDataContext" "_context" "" Private Readonly NonStatic,Property "IBruger" "_bruger" "" Private Readonly NonStatic,Property "ITolkeBrugerQuery" "_tolkeBrugerQuery" "" Private Readonly NonStatic,Constructor Public [Parameter "DatabaseDataContext" "context",Parameter "IBruger" "bruger",Parameter "ITolkeBrugerQuery" "tolkeBrugerQuery"] "\n            _context = context;\n            _bruger = bruger;\n            _tolkeBrugerQuery = tolkeBrugerQuery;\n        ",Method Public "SagModel" "Get" [Parameter "int" "id"] "\n        ",Method Public "List<SagModel>" "GetAfsluttedeSagerForMyndighed" [Parameter "int" "myndighedId"] "\n            Console.writeline(\"ASDASD\");\n        "]})
